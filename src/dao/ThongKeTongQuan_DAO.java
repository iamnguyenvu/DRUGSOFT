...
public class ThongKeTongQuan_DAO {
    ...
    public static ArrayList<ModelLineChart> getLineChartPrevData(DateRange dateRange, LocalDate startDate, LocalDate endDate) {
        Connection con = connectDB.accessDataBase();
        if (con == null) return null;
        ...
        try {
            ...
            LocalDate prevStartDate = startDate;
            LocalDate prevEndDate = endDate;

            switch (dateRange) {
            case LAST_7_DAYS:
                prevStartDate = startDate.minusDays(7);
                prevEndDate = endDate.minusDays(7);
                break;
            case LAST_30_DAYS:
                prevStartDate = startDate.minusDays(30);
                prevEndDate = endDate.minusDays(30);
                break;
            case THIS_MONTH:
                ...
                break;
            case LAST_MONTH:
                prevStartDate = LocalDate.of(startDate.getYear(), startDate.getMonth(), 1).minusMonths(1);
                prevEndDate = prevStartDate.withDayOfMonth(prevStartDate.lengthOfMonth());
                break;
            case THIS_YEAR:
                prevStartDate = LocalDate.of(startDate.getYear() - 1, 1, 1);
                prevEndDate = LocalDate.of(startDate.getYear() - 1, 12, 31);
                break;
            case LAST_YEAR:
    ...
    public static ArrayList<ModelTopSanPham> getChartPrevDataTopSanPham(DateRange dateRange, LocalDate startDate, LocalDate endDate) {
        Connection con = connectDB.accessDataBase();
        if (con == null) return null;
    ...
    public static ArrayList<ModelTopNhanVien> getChartPrevDataTopNhanVien(DateRange dateRange, LocalDate startDate, LocalDate endDate) {
        Connection con = connectDB.accessDataBase();
        if (con == null) return null;
