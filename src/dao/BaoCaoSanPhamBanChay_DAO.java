 ...
 * @author Vovan
 */
public class BaoCaoSanPhamBanChay_DAO {
    public ArrayList<BaoCaoSanPhamBanChay_enity> getAllBaoCaoSanPhamBanChay( int select) {
    ...
    public ArrayList<BaoCaoSanPhamBanChay_enity> getSanPhamBanChayTuyChinh(Date from, Date to) {
    ArrayList<BaoCaoSanPhamBanChay_enity> list = new ArrayList<>();
    Connection connection = null;
