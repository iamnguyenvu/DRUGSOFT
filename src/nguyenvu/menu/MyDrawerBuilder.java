...
public class MyDrawerBuilder extends SimpleDrawerBuilder {
	...
	public SimpleHeaderData getSimpleHeaderData() {
		...
		if (this.user == null) {
			...
			icon.setBorder(2);
			return new SimpleHeaderData().setIcon(icon).setTitle("").setDescription("")
		...
		icon.setBorder(2);
		return new SimpleHeaderData().setIcon(icon).setTitle(this.user.getName())
	...
	public SimpleMenuOption getSimpleMenuOption() {
		...
		MenuItem items[] = new MenuItem[] { new Item("Trang chủ", "dashboard.svg"), new Item.Label("QUẢN LÝ"),
				new Item("Bán hàng", "email.svg"), new Item("Đổi trả", "chat.svg"),
				new Item("Sản phẩm", "calendar.svg"), new Item("Hóa đơn", "forms.svg"),
				new Item("Khách hàng", "ui.svg"), new Item("Nhân viên", "icon.svg"), new Item("Tài khoản", "key.svg"),
				new Item("Thống kê", "chart.svg").subMenu("Sản phẩm sắp hết hạn").subMenu("Sản phẩm sắp hết hàng")
						.subMenu("Doanh số nhân viên").subMenu("Doanh số tổng quan"),
				new Item("Báo cáo", "page.svg"), new Item.Label("KHÁC"), new Item("Đăng xuất", "logout.svg") };
...
//                            checkMenu(index, new int[]{6}) && 
		...
		simpleMenuOption.setMenuStyle(new SimpleMenuStyle() {
			...
			public void styleMenuItem(JButton menu, int[] index) {
				menu.putClientProperty(FlatClientProperties.STYLE, "" + "[light]foreground:#FAFAFA;" + "arc:10");
			}

			@Override
			public void styleMenu(JComponent component) {
				component.putClientProperty(FlatClientProperties.STYLE, "" + "background:$Drawer.background");
			}
		...
		simpleMenuOption.setMenus(items).setBaseIconPath("nguyenvu/resources/menu").setIconScale(0.45f);
