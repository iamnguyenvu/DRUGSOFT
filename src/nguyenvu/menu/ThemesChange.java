...
public class ThemesChange extends JPanel {
    ...
    private void init() {
        ...
        JButton buttonLight = new JButton(createIcon("nguyenvu/resources/icon/light.svg"));
        JButton buttonDark = new JButton(createIcon("nguyenvu/resources/icon/dark.svg"));
