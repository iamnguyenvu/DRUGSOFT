...
import nguyenvu.swing.slider.PanelSlider;
import nguyenvu.swing.slider.SimpleTransition;
import nguyenvu.swing.slider.SliderTransition;
...
public class MainForm extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        cmdMenu = createButton(new FlatSVGIcon("nguyenvu/resources/icon/menu.svg"));
        cmdUndo = createButton(new FlatSVGIcon("nguyenvu/resources/icon/undo.svg"));
        cmdRedo = createButton(new FlatSVGIcon("nguyenvu/resources/icon/redo.svg"));
        cmdRefresh = createButton(new FlatSVGIcon("nguyenvu/resources/icon/refresh.svg"));
