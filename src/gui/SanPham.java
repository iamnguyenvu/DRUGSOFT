...
//		tb_SanPham.getColumn("Xóa").setCellRenderer((TableCellRenderer) new DeleteButtonPanel());
		...
		tb_SanPham.getColumn("Xóa").setCellEditor(new ButtonEditor("Xóa", new ActionListener() {
		    ...
		    public void actionPerformed(ActionEvent e) {
		        ...
		        if (command.startsWith("Xóa")) {
		            ...
		            int confirm = JOptionPane.showConfirmDialog(tb_SanPham, 
		                    "Bạn có xác nhận xóa không?", 
		                    "Xác nhận xóa", 
		                    JOptionPane.YES_NO_OPTION);
		            
		            if (confirm == JOptionPane.YES_OPTION) {
		                System.out.println("Đã xóa dòng: " + row);
		                // Xóa dữ liệu từ model của bảng
		                dftb_SanPham.removeRow(row); // Thực hiện xóa dòng trong TableModel
		            } else {
		...
		pn_SapXepTheoGia.setBackground(new Color(91, 173, 255));
		...
		radio_giaTuThapDenCao.setBackground(new Color(91, 173, 255));
		...
		radio_giaTuCaoDenThap.setBackground(new Color(91, 173, 255));
		...
		pn_NgayHetHan.setBackground(new Color(91, 173, 255));
		...
		radio_NhhTangdan.setBackground(new Color(91, 173, 255));
		...
		radio_NhhGiamdan.setBackground(new Color(91, 173, 255));
