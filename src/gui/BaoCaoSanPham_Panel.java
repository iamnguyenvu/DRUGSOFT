 ...
 * @author Vovan
 */
public class BaoCaoSanPham_Panel extends javax.swing.JPanel {
     ...
     */
    public BaoCaoSanPham_Panel(int select) {
        initComponents();
    ...
    public void loadData(int currentPage, int rowsPerPage, int select) {
        ...
        dao = new BaoCaoSanPhamBanChay_DAO();
        ArrayList<BaoCaoSanPhamBanChay_enity> dsBaoCao = dao.getAllBaoCaoSanPhamBanChay(select);
    ...
    public void loadDataTuyChinh(Date from, Date to ) {
        ...
        dao = new BaoCaoSanPhamBanChay_DAO();
        ArrayList<BaoCaoSanPhamBanChay_enity> dsBaoCao = dao.getSanPhamBanChayTuyChinh(from, to);
    ...
    try {
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            // Lấy dữ liệu báo cáo
            if (selected == 7) {
                reportData = dao.getAllBaoCaoSanPhamBanChay(7);
            } else if (selected == 30) {
                reportData = dao.getAllBaoCaoSanPhamBanChay(30);
            } else if (selected == 90) {
                reportData = dao.getAllBaoCaoSanPhamBanChay(90);
            } else if (selected == 365) {
                reportData = dao.getAllBaoCaoSanPhamBanChay(365);
            } else if (selected == 0) {
                reportData = dao.getAllBaoCaoSanPhamBanChay(0);
            } else {
                reportData = dao.getSanPhamBanChayTuyChinh(selectedStartDate, selectedEndDate);
            }
