...
public class NhapHangLuuTam extends SimpleForm {
    ...
    private void initComponents() {
        ...
        btnDSLT = new JButton("Danh Sách Lưu Tạm");
        		...
        		.addGroup(pnHeaderLayout.createSequentialGroup()
        			...
        			.addGroup(pnHeaderLayout.createParallelGroup(Alignment.TRAILING)
        				.addGroup(pnHeaderLayout.createParallelGroup(Alignment.BASELINE)
        					...
        					.addComponent(btnDSLT, GroupLayout.PREFERRED_SIZE, 44, GroupLayout.PREFERRED_SIZE))
      ...
      public void keyReleased(KeyEvent e) {
        ...
        btnHuy = new JButton();
        btnHuy.setText("[F7] Lưu tạm");
        btnHuy.setForeground(Color.WHITE);
        btnHuy.setBackground(new Color(255, 0, 0));
        btnHuy.setBounds(10, 440, 162, 87);
        panel.add(btnHuy);
