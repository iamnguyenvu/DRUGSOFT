...
public class pnSanPhamHetHang extends SimpleForm implements ActionListener{
    ...
    public pnSanPhamHetHang() {
        ...
        lblNewLabel = new JLabel("Danh Sách Sản Phẩm Hết Hàng");
        lblNewLabel.setForeground(new Color(0, 0, 0));
        lblNewLabel.setBackground(new Color(255, 255, 255));
        lblNewLabel.setFont(new Font("Arial", Font.BOLD, 18));
        lblNewLabel.setBounds(10, 10, 325, 40);
		...
		scp_SanPham.setBounds(10, 80, 1480, 443);
        ...
        btnXuatFile.setBounds(1157, 560, 145, 40);
        ...
        btnBaoCao.setBounds(1312, 560, 145, 40);
    ...
    private void initComponents() {
        ...
        pnCenter.setBounds(10, 22, 1500, 628);
