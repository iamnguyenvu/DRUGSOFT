...
public class DoanhSoBanHang extends SimpleForm{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (startDate == null || endDate == null) {
            // Nếu không có ngày nào được chọn, thông báo lỗi và dừng lại
    ...
    private void themData(java.util.Date startDate, java.util.Date endDate) {
        ...
        try {
        	java.util.List<ModelData> lists = new ArrayList<>();
            ...
            String sql = "SELECT MONTH(ngayLapHD) AS Thang,SUM(tongTien - tienGiam) AS DoanhSo FROM HoaDon WHERE ngayLapHD BETWEEN ? AND ? GROUP BY MONTH(ngayLapHD) ORDER BY Thang;";
            ...
            while (r.next()) {
                ...
                int doangSo = r.getInt("DoanhSo");

                // Add data to your model for the chart
                ModelChart modelChart = new ModelChart(thang, new double[]{doangSo});
